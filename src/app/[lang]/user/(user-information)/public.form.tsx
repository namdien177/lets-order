...
import {
  ...
  publicProfileSchema,
} from "@/app/user/(user-information)/schema";
...
const PublicInformationForm = ({
  ...
  const submitMutate = async (data: PublicProfilePayload) => {
    ...
    <form onSubmit={handleSubmit(submitMutate)}>
      <CardContent>
        <div className="flex flex-col gap-4">
          <ErrorField name={"displayName"} errors={errors} />
          <ErrorField name={"avatar"} errors={errors} />
